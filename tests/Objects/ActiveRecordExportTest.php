...
class ActiveRecordExportTest extends BaseTest {
  public function testModelToArray(){
    /* @var $test_model TestModel */
    $test_model = TestModel::factory();
    $test_model->integer_field = $this->faker->randomNumber(5);
    $test_model->text_field = $this->faker->paragraph;
    $test_model->date_field = $this->faker->datetime->format(self::TIME_STORAGE_FORMAT);
